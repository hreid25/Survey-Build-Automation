...
# if str(excelrowlistobject[1]) in current_sergeant_question_id_list:
#     "//*[starts-with(@class,'question-text-area sortable-disabled')]/following::strong[position()=2 and contains(text(),'" + str(
#         excelrowlistobject[1]) + "')]/parent::span/preceding::textarea[position()=1]"
# Check to see if question has already been added, and then add custom id into the array.
